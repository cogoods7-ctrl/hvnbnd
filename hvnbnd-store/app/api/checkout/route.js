...
export async function POST(request) {
  try {
    ...
    const freeShippingThreshold = Number(settings?.free_shipping_threshold ?? 75);
    ...
    // Stripe checkout page and receipt, not silently folded into the total.
    // "total" here is still just the item subtotal — checked against the
    // threshold before shipping gets added below.
