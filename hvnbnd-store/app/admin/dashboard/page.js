    ...
    <div className="admin-shell">
      ...
      {tab === 'orders' && (
        orders.length === 0 ? (
          ...
          <div className="table-scroll">
          <table>
            <thead><tr><th></th><th>Order</th><th>Customer</th><th>Items</th><th>Total</th><th>Tax</th><th>Status</th><th>Date</th></tr></thead>
            <tbody>
              {orders.map((o) => {
                ...
                return (
                  <Fragment key={o.id}>
                    ...
                    {isOpen && (
                      <tr key={o.id + '-detail'}>
                        <td colSpan={8} style={{ background: 'var(--bg)', padding: 20 }}>
